$(document).ready(function() {
  ...
  var APPLICATION_ID = 'XCO4VPMR9R';
  var SEARCH_ONLY_API_KEY = '4bf46bb5a900207b7a3ffc341272cbc1';
  var INDEX_NAME = 'nn';
  var PARAMS = {
    hitsPerPage: 10,
    maxValuesPerFacet: 8,
    facets: ['type'],
    disjunctiveFacets: ['categories', 'lastname', 'shipname', 'country', 'lifespan']
  };
  var FACETS_SLIDER = ['lifespan'];
  var FACETS_ORDER_OF_DISPLAY = ['categories', 'country'];
  var FACETS_LABELS = {categories: 'Category', country: 'Country'};
